...
// //  import Styles, {AppColors, AppFonts} from './AppStyle.js';
...
//                        <View>
//                            <TextInput  onChangeText={destination => this.setState({destination})} value={this.state.destination}/>
 
//                            <TouchableOpacity  onPress={() => this.goDisplayRoute()}>
//                                <Text >{'\ue961'}</Text>
//                            </TouchableOpacity>
 
//                            <TouchableOpacity  onPress={() => this.goNavigateRoute()}>
//                                <Text >{'\ue975'}</Text>
//                            </TouchableOpacity>
