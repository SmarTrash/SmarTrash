...
namespace SmarTrash.Models
{
    ...
    public static class TimerServices
    {
        ...
        {
            string[] message =  { "הכדור שלנו החוויר בואו נמחזר ונחזיר לו את הצבע", 
                                   "עולם ירוק שמיים כחולים ממחר ממחזרים", 
                                   "מחזירים את הצבע לכדור שלנו - ממחזרים",
                                   "את האשפה מפרידים את הכדור מנקים",
                                  "שמור על הסביבה והסביבה תשמור עליך",};
